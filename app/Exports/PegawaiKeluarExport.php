...
class PegawaiKeluarExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnFormatting, WithCustomValueBinder
{
    private $bulan;
    private $tahun;
    ...
    public function bindValue(Cell $cell, $value)
    {
        ...
        $textColumns = ['A', 'B', 'C', 'D', 'K', 'Y', 'Z', 'AA', 'AB', 'AC', 'AD', 'AE', 'AH', 'AI', 'AK', 'AL', 'AM', 'AN'];
    ...
    /**
     * Query data pegawai keluar sesuai dengan sistem HRD original
     * STATUS_PEG = 2 untuk pegawai keluar
     */
    ...
    /**
     * Headers sesuai dengan sistem HRD original untuk pegawai keluar
     * 68 kolom (tanpa STR/SIP data)
     */
     ...
     * Format sesuai dengan sistem HRD original untuk pegawai keluar
     */
    public function map($row): array
    {
        ...
        return [
            ...
            $formatDate($row->tgl_keluar_pensiun ?? '')           // TMT KELUAR (sesuai original)
        ];
    }
