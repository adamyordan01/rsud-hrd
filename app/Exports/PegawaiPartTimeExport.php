...
class PegawaiPartTimeExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnFormatting, WithCustomValueBinder
{
    private $bulan;
    private $tahun;
    ...
    /**
     * Query data pegawai part time
     * Sesuai dengan query original: STATUS_PEG = 1 AND KD_STATUS_KERJA = 4
     */
    public function collection()
    {
        $sql = "SELECT * FROM VIEW_TAMPIL_KARYAWAN 
                WHERE STATUS_PEG = 1 
                  AND KD_STATUS_KERJA = 4 
