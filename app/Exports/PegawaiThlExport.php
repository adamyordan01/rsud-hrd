...
class PegawaiThlExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnFormatting, WithCustomValueBinder
{
    private $bulan;
    private $tahun;
    ...
    /**
     * Query data pegawai THL (Tenaga Harian Lepas)
     * Sesuai dengan query original: STATUS_PEG = 1 AND KD_STATUS_KERJA = 6
     */
    public function collection()
    {
        $sql = "SELECT * FROM VIEW_TAMPIL_KARYAWAN 
                WHERE STATUS_PEG = 1 
                  AND KD_STATUS_KERJA = 6 
     ...
     * 68 kolom (tanpa STR/SIP karena bukan khusus tenaga medis)
     */
