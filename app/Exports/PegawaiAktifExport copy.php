...
class PegawaiAktifExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnFormatting
{
    private $bulan;
    private $tahun;
    ...
    public function map($row): array
    {
        ...
        // Format nomor sebagai string dengan awalan ' untuk mencegah scientific notation
    ...
    public function columnFormats(): array
    {
        return [
            ...
            'X' => NumberFormat::FORMAT_TEXT,  // NO ASKES / BPJS KESEHATAN
            ...
            'AB' => NumberFormat::FORMAT_TEXT, // BPJS KETENAGAKERJAAN
            ...
            'AM' => NumberFormat::FORMAT_TEXT, // NO REKENING BNI SYARIAH
            'AN' => NumberFormat::FORMAT_TEXT, // NO REKENING MANDIRI
