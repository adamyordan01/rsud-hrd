...
class PegawaiPensiunExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnFormatting, WithCustomValueBinder
{
    private $bulan;
    private $tahun;
    ...
    /**
     * Query data pegawai pensiun - menggunakan raw SQL seperti sistem HRD original
     * STATUS_PEG = 3 untuk pegawai pensiun
     */
    public function collection()
    {
        // Query pegawai pensiun dengan STR dan SIP (jika diperlukan untuk laporan)
    ...
    /**
     * Headers sesuai dengan yang ada di sistem HRD original (sama seperti PegawaiAktif)
     * 75 kolom termasuk STR/SIP
     */
     ...
     * Format sesuai dengan sistem HRD original untuk pegawai pensiun
     */
    public function map($row): array
    {
        ...
        return [
            ...
            $formatDate($row->tgl_keluar_pensiun ?? '')           // TMT PENSIUN (field yang sama dengan keluar)
        ];
    }
