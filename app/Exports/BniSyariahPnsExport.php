...
class BniSyariahPnsExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnFormatting, WithCustomValueBinder
{
    private $bulan;
    private $tahun;
    ...
    /**
     * Query data ASN (PNS + PPPK) + Honor untuk BNI Syariah
     * KD_STATUS_KERJA in (1, 2, 7) - PNS, Honor, PPPK
     * KD_JENIS_TENAGA not in ('0') - semua kecuali yang tidak aktif
     * STATUS_PEG = 1 - aktif
     */
    public function collection()
    {
        // Query dengan penambahan PPPK (KD_STATUS_KERJA = 7) sesuai permintaan
        $sql = "SELECT KD_KARYAWAN, 
                ...
                WHERE KD_STATUS_KERJA IN ('1','2','7') 
                AND KD_JENIS_TENAGA NOT IN ('0') 
                AND STATUS_PEG = 1 
     ...
     * Format sesuai dengan sistem HRD original untuk BNI Syariah PNS
     */
