...
class PegawaiHonorExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnFormatting, WithCustomValueBinder
{
    private $bulan;
    private $tahun;
    ...
    public function bindValue(Cell $cell, $value)
    {
        ...
        $textColumns = ['A', 'B', 'C', 'D', 'K', 'Y', 'Z', 'AA', 'AB', 'AD', 'AE', 'AH', 'AI', 'AK', 'AL', 'AM'];
    ...
    /**
     * Query data pegawai honor - menggunakan VIEW_TAMPIL_KARYAWAN seperti sistem HRD original
     */
    public function collection()
    {
        // Query yang sama dengan sistem HRD original untuk pegawai honor
        $sql = "SELECT * FROM VIEW_TAMPIL_KARYAWAN 
                WHERE STATUS_PEG = 1 AND KD_STATUS_KERJA = 2 
    ...
    /**
     * Headers sesuai dengan yang ada di sistem HRD original (Pegawai Honor)
     */
     ...
     * Sesuai dengan format Pegawai Honor original
     */
    public function map($row): array
    {
        ...
        // Konversi jenis kelamin sesuai original: Wanita → P, Pria → L, kosong → ?
        $jenisKelamin = '';
        ...
        return [
            ...
            $jenisKelamin,                                        // JENIS KELAMIN (P/L/?)
