...
class PegawaiPenunjangMedisExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnFormatting, WithCustomValueBinder, WithEvents
{
    private $bulan;
    private $tahun;
    ...
    /**
     * Query data penunjang medis sesuai dengan sistem HRD original
     * Menggabungkan data dengan STR/SIP untuk RS Online
     * Dengan header PENUNJANG MEDIS
     */
    public function collection()
    {
        ...
        // Buat collection dengan header PENUNJANG MEDIS
        $collection = collect();
        
        // Tambahkan header row seperti pada file original
        $headerRow = (object) [
            'row_type' => 'HEADER',
            'kategori_detail' => 'PENUNJANG MEDIS',
     ...
     * 27 kolom termasuk STR/SIP untuk penunjang medis (tidak ada NO ABSEN)
     */
    ...
    public function map($row): array
    {
        ...
        if (isset($row->row_type) && $row->row_type === 'HEADER') {
            ...
            $result[0] = $row->nama; // Isi kolom pertama dengan "PENUNJANG MEDIS"
            return $result;
        }
    ...
    /**
     * Register events untuk styling row header PENUNJANG MEDIS
     */
