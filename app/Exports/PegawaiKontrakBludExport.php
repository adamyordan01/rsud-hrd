...
class PegawaiKontrakBludExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnFormatting, WithCustomValueBinder
{
    private $bulan;
    private $tahun;
    ...
    /**
     * Query data pegawai kontrak BLUD
     * Sesuai dengan query original: KD_STATUS_KERJA = 3 AND STATUS_PEG = 1 AND KD_JENIS_PEG = 2
     */
