                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-senter">
                                <i
                                    class="ki-outline ki-arrow-up-right fs-2 text-success me-2"></i>
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-senter">
                                <i
                                    class="ki-outline ki-arrow-down-right fs-2 text-danger me-2"></i>
                ...
                <div class="card h-md-100">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-900">What’s up
                                Today</span>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="d-flex flex-stack mt-auto bd-highlight">
                                        ...
                                        <!--begin::Actions-->
                                        <a href="/metronic8/demo39/apps/projects/project.html"
                        ...
                        <div class="row align-items-center h-100">
                            ...
                            <div class="col-7 ps-xl-13">
                                ...
                                <span
                                    ...
                                    Flat cartoony and illustrations with vivid unblended purple
                                    hair lady
                                </span>
                                <!--end::Text-->
            ...
            <div class="col-xl-8">
                ...
                <div class="card card-flush h-md-100">
                    ...
                    <div class="card-header pt-7">
                        ...
                        <!--begin::Toolbar-->
                        <div class="card-toolbar">
                            <a href="/metronic8/demo39/apps/ecommerce/catalog/add-product.html"
                    ...
                    <div class="card-body d-flex flex-column flex-center">
                        ...
                        <div class="text-center mb-1">
                            ...
                            <a class="btn btn-sm btn-light"
                                href="/metronic8/demo39/apps/user-management/users/view.html">
                                Learn More </a>
                            <!--end::Link-->
                        </div>
                        <!--end::Links-->
                ...
                <div class="card h-md-100">
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="tab-content">
                            <!--begin::Tab pane-->
                            <div class="tab-pane active" id="kt_timeline_widget_4_tab_day"
                                ...
                                <div class="table-responsive pb-10">
                                    ...
                                    <div id="kt_timeline_widget_4_1"
                                        ...
                                        data-kt-timeline-widget-4-image-root="/metronic8/demo39/assets/media/">
                                    </div>
                                    <!--end::Timeline-->
                                </div>
                            </div>
                            ...
                            <!--begin::Tab pane-->
                            <div class="tab-pane" id="kt_timeline_widget_4_tab_week"
                            ...
                            <!--begin::Tab pane-->
                            <div class="tab-pane" id="kt_timeline_widget_4_tab_month"
                            ...
                            <!--begin::Tab pane-->
                            <div class="tab-pane" id="kt_timeline_widget_4_tab_2022"
                                role="tabpanel" aria-labelledby="week-tab"
                                data-kt-timeline-widget-4-blockui="true">
                                <div class="table-responsive pb-10">
                                    <!--begin::Timeline-->
