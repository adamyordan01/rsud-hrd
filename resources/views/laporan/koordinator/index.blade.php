@extends('layouts.backend', ['title' => 'Laporan Koordinator'])

@push('styles')
<style>
    #table-koordinator th {
        font-size: 11px;
        vertical-align: middle;
        text-align: center;
    }
    
    #table-koordinator td {
        font-size: 11px;
        vertical-align: top;
    }
        ...
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                    ...
                    <li class="breadcrumb-item text-muted">Koordinator</li>
                </ul>
            </div>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <button type="button" class="btn btn-light-primary btn-sm" onclick="printKoordinator()">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="fw-bold">Daftar Koordinator {{ date('Y') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <!-- Filter Section -->
                        <div class="filter-container">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select class="form-select" name="bulan" id="bulan-koordinator">
                                ...
                                <div class="col-md-3">
                                    <select class="form-select" name="tahun" id="tahun-koordinator">
                                ...
                                <div class="col-md-3">
                                    <button class="btn btn-primary" onclick="lihatKoordinator()">
                        ...
                        <!-- Loading -->
                        <div class="loader-container" id="loader-koordinator">
                        ...
                        <!-- Data Table -->
                        <div class="table-responsive" id="data-koordinator">
                            <table class="table table-striped table-bordered" id="table-koordinator" width="100%">
                                <thead>
                                    <tr>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#bulan-koordinator').val('{{ str_pad(date("m"), 2, "0", STR_PAD_LEFT) }}');
            $('#tahun-koordinator').val('{{ date("Y") }}');
        ...
        function initDataTable() {
            ...
            table = $('#table-koordinator').DataTable({
                processing: true,
                serverSide: true,
                searchDelay: 800, // Debounce delay 800ms
                ajax: {
                    url: '{{ route("admin.laporan.koordinator.index") }}',
                    data: function(d) {
                        d.bulan = $('#bulan-koordinator').val();
                        d.tahun = $('#tahun-koordinator').val();
                    }
                },
                columns: [
        ...
        function lihatKoordinator() {
            const bulan = $('#bulan-koordinator').val();
            const tahun = $('#tahun-koordinator').val();
            ...
            $.ajax({
                url: '{{ route("admin.laporan.koordinator.check-data") }}',
                type: 'GET',
                data: {
                    bulan: bulan,
                    tahun: tahun
                ...
                success: function(response) {
                    if (response.count > 0) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: `Ditemukan ${response.count} data koordinator untuk periode ${getMonthName(bulan)} ${tahun}`
                        });
                    } else {
                        Swal.fire({
                            icon: 'info',
                            title: 'Informasi',
                            text: `Tidak ada data koordinator untuk periode ${getMonthName(bulan)} ${tahun}`
                        });
                    }
                },
                error: function() {
        ...
        function printKoordinator() {
            ...
            const printUrl = `{{ route('admin.laporan.koordinator.print') }}?bln=${bulan}&thn=${tahun}`;
