...
<head>
    ...
    <title>HRD RSUD LANGSA - Laporan Jumlah Pegawai Per-Pendidikan Per-Ruangan</title>
...
<body class="text-center" onLoad="cetak()">
    ...
    <div class="report-title">
        <b style='font-size:10pt;'>JUMLAH PEGAWAI PER-PENDIDIKAN PER-RUANGAN</b><br>
            ...
            @if(count($result) > 0)
                @foreach($result as $ruangan)
                    ...
                    <tr class="ruangan-header">
                        <td colspan="8" class="text-center">{{ $ruangan['ruangan'] }}</td>
                    </tr>
                    
                    @foreach($ruangan['jenis_tenaga_groups'] as $group)
                        <!-- Header Jenis Tenaga -->
                        <tr class="group-header">
                            <td colspan="8" class="text-left">TENAGA {{ $group['jenis_tenaga'] }}</td>
                        </tr>
                    ...
                    <tr class="ruangan-total-row">
                        ...
                        <td class="text-center">{{ $ruangan['ruangan_total']['honor'] }}</td>
                        <td class="text-center">{{ $ruangan['ruangan_total']['kontrak'] }}</td>
