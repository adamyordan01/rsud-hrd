    ...
    <div class="d-flex flex-stack flex-grow-1">
        ...
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <a href="{{ route('user.dashboard') }}" class="app-sidebar-logo">
                ...
                <img alt="Logo" src="{{ asset('assets/media/logos/logo-hrd.png') }}" class="h-35px theme-dark-show" />
            </a>
        </div>
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6 me-2 me-lg-6" id="kt_header_user_menu_toggle">
                ...
                @php
                    // Ambil nama user
                    $userNama = auth()->user()->karyawan->nama ?? auth()->user()->name ?? 'User';
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px"
                    ...
                    <img
                        src="{{ $avatar }}"
                        alt="{{ auth()->user()->karyawan->nama ?? auth()->user()->name ?? 'User' }}"
                    />
                </div>
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-325px"
                        ...
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">
                                    {{ auth()->user()->karyawan->nama ?? auth()->user()->name ?? 'User' }}
                                </div>

                                <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">
                                    {{ auth()->user()->karyawan->kd_karyawan ?? '' }} - {{ auth()->user()->karyawan->email ?? auth()->user()->email ?? 'user@email.com' }}
                                </a>
                            </div>
                            <!--end::Username-->
                        </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{ route('user.profil.index') }}" class="menu-link px-5">
                            My Profile
                        </a>
                    </div>
                    <!--end::Menu item-->
                    ...
                    <!--begin::Menu item-->
                    <div class="menu-item px-5">
                        <a href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="menu-link px-5">
                            Sign Out
                        </a>
                    </div>
