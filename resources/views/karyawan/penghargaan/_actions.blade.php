...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3 edit" data-karyawan="{{ $penghargaan->kd_karyawan }}" data-urut="{{ $penghargaan->urut_peng }}">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="#" class="menu-link px-3 delete-penghargaan" data-karyawan="{{ $penghargaan->kd_karyawan }}" data-urut="{{ $penghargaan->urut_peng }}" data-event="{{ $penghargaan->event }}">
