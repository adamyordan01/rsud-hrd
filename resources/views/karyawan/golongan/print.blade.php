...
<head>
    ...
    <title>Cetak Pegawai - Golongan {{ $golonganName->kd_gol ?? '' }}</title>
    <style>
        body {
            font-family: cambria;
            margin: 0;
        ...
        /* Color coding untuk kelengkapan data */
        .merah {
...
<body class="text-center" style="font-family: cambria" id="all" onLoad="cetak()">
    ...
    {{-- <b style="font-size:10pt;">LAPORAN PEGAWAI BERDASARKAN GOLONGAN - {{ $golonganName->kd_gol ?? '' }} - {{ $golonganName->pangkat ?? '' }}</b> --}}
    <b style="font-size:10pt;">LAPORAN PEGAWAI BERDASARKAN GOLONGAN - {{ $golonganName->kd_gol ?? '' }}</b>
