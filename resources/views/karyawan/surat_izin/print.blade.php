...
<body>
    {{-- <div class="no-print" style="margin-bottom: 20px;">
        <button onclick="cetak()" style="padding: 10px 20px; background: #007bff; color: white; border: none; border-radius: 4px; cursor: pointer;">Print</button>
    ...
    <div class="text-center">
        ...
        <b>DI LINGKUNGAN {{ strtoupper(config('app.company_name', 'RSUD LANGSA')) }}</b>
    </div>
    ...
    <table width="100%">
        <tr>
            ...
            <td align="center">
                ...
                @endphp
                Langsa, {{ tgl_indo_sekarang(date('Y-m-d')) }}<br>
    ...
    {{-- @if($surat->status !== 'pending')
        <div style="margin-top: 30px; font-size: 10px; color: #666; border-top: 1px solid #ccc; padding-top: 10px;">
            <p><strong>Status Surat:</strong> 
                ...
                @endif
                | <strong>Dicetak pada:</strong> {{ tgl_indo_sekarang(date('Y-m-d')) }} pukul {{ date('H:i') }} WIB
            </p>
        </div>
    @endif --}}
</body>
