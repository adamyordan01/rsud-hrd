...
<head>
    ...
    <title>Cetak Pegawai - Per Ruangan</title>
    <style>
        body {
            font-family: cambria;
            margin: 0;
...
<body class="text-center" style="font-family: cambria" id="all" onLoad="cetak()">
    ...
    <b style="font-size:10pt;">{{ $judulLaporan }}</b>
            ...
            @else
                @foreach($karyawanData as $index => $data)
                    @php
                        ...
                        if ($data->kd_status_kerja == 1) {
                            $totalFields = $totalFields - 12;
                        } else {
                            $totalFields = $totalFields - 36;
                        }
                        
                        $percentage = $totalFields > 0 ? ($filledFields * 100) / $totalFields : 0;
