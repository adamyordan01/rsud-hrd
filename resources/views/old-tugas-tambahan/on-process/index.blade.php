            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <span class="text-muted text-hover-primary">Daftar Tugas Tambahan (Proses)</span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div id="kt_app_content_container" class="app-container  container-fluid ">
            ...
            <div class="card mb-5">
                ...
                <div class="card-body ps-lg-12 pt-lg-0 pb-lg-0">
                    <div class="row g-5 mb-5" id="list-tugas-tambahan-verifikasi">
                        <div class="table-responsive">
                            <table class="table table-bordered table-stripped align-middle" id="tugas-tambahan-on-process-table">
                                <thead>
                                    <tr>
                                        <th class="text-center">Kd. Tugas Tambahan</th>
                                        <th>ID Peg.</th>
                                ...
                                <tbody>
                                    @forelse ($getTugasTambahan as $item)
                                        @php
                                            $query = $DB::table('view_proses_tugas_tambahan')
                                        ...
                                        @foreach ($query as $data)
                                            ...
                                            @endphp
                                            <tr>
                                                <td class="text-center">{{ $data->kd_tugas_tambahan }}</td>
                                                ...
                                                <td>
                                                    @if ($data->verif_1 == null)
                                                        @if ($jabatan == 19 || $ruangan == 57)
                                                            <a
                                                                ...
                                                                data-url="{{ route('admin.tugas-tambahan-on-process.first-verification') }}"
                                                    ...
                                                    @elseif($data->verif_2 == null)
                                                        @if ($jabatan == 7 || $ruangan == 57)
                                                            <a
                                                                ...
                                                                data-id="{{ $data->kd_tugas_tambahan }}"
                                                                data-karyawan="{{ $data->kd_karyawan }}"
                                                                data-url="{{ route('admin.tugas-tambahan-on-process.second-verification') }}"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_verif"
                                                                id="verif2"
                                                            >
                                                    ...
                                                    @elseif($data->verif_3 == null)
                                                        @if ($jabatan == 3 || $ruangan == 57)
                                                            <a
                                                                ...
                                                                data-id="{{ $data->kd_tugas_tambahan }}"
                                                                data-karyawan="{{ $data->kd_karyawan }}"
                                                                data-url="{{ route('admin.tugas-tambahan-on-process.third-verification') }}"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_verif"
                                                                id="verif3"
                                                            >
                                                        ...
                                                        @if ($jabatan == 1 || $ruangan == 57)
                                                            <a
                                                                ...
                                                                data-id="{{ $data->kd_tugas_tambahan }}"
                                                                data-karyawan="{{ $data->kd_karyawan }}"
                                                                data-url="{{ route('admin.tugas-tambahan-on-process.fourth-verification') }}"
                                                                id="verif4"
                                                            >
                                                                <i class='ki-duotone ki-double-check fs-2'><span class='path1'></span><span class='path2'></span></i>
                                                                Menunggu verifikasi Direktur
                                                    ...
                                                    @if ($ruangan == 91 || $ruangan == 57)
                                                        <a
                                                            href="{{ route('admin.tugas-tambahan.edit-tugas-tambahan-on-process', $item->kd_tugas_tambahan) }}"
                                                    ...
                                                    @endif
                                                    <a
                                                        href="{{ route('admin.tugas-tambahan-on-process.print-draft-sk', [$data->kd_karyawan, $data->kd_tugas_tambahan]) }}"
                                                        target="_blank"
                                                        class="btn btn-primary btn-sm d-block mb-2"
                                                    >
        ...
        <div class="modal-dialog modal-dialog-scrollable mw-800px">
            <div class="modal-content">
                ...
                <div class="modal-body px-5 mb-7" id="finalisasi">
                    <form action="#">
                        @csrf
                        <input type="hidden" name="kd_tugas_tambahan_finalisasi" id="kd_tugas_tambahan_finalisasi">
        ...
        <div class="modal-dialog modal-dialog-scrollable mw-800px">
            <div class="modal-content">
                <div class="modal-header" id="kt_modal_log_header">
                    <h2 class="fw-bold">Log Tugas Tambahan</h2>
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#tugas-tambahan-on-process-table').DataTable({
                info: true,
                order: [],
                pageLength: 10,
                lengthChange: true,
            ...
            $(document).on('click', '#log', function () {
                ...
                $.ajax({
                    url: '{{ route("admin.tugas-tambahan-on-process.get-log-tugas-tambahan") }}',
                    method: 'GET',
                    data: {
        ...
        $(document).on('click', '#verif1, #verif2, #verif3', function () {
            ...
            $.ajax({
                url: '{{ route("admin.tugas-tambahan-on-process.rincian") }}',
                method: 'GET',
                data: {
                    kd_tugas_tambahan: id,
                    kd_karyawan: karyawan
        ...
        $(document).on('click', '[data-kt-menu-modal-action-verif-4="submit"]', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route("admin.tugas-tambahan-on-process.fourth-verification") }}',
                        method: 'POST',
                        processData: false,
                        contentType: false,
                        dataType: 'json',
