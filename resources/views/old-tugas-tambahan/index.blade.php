            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <span class="text-muted text-hover-primary">Tugas Tambahan</span>
                        </li>
                    </ul>
                </div>
            </div>
...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid ">
        <div id="kt_app_content_container" class="app-container container-fluid ">
            ...
            <form class="form" novalidate="novalidate" id="add-tugas-tambahan" method="POST" action="{{ route('admin.tugas-tambahan.store') }}">
                @csrf
    ...
    <script>
        ...
        $('#kd_karyawan').keyup(function (e) {
            ...
            if (length == 6) {
                ...
                $.ajax({
                    url: "{{ route('admin.tugas-tambahan.check-pegawai', '') }}/" + e.target.value,
                    type: "GET",
                    dataType: "json",
                    data: {
                        id: e.target.value
        ...
        $('#kd_karyawan').keypress(function (e) {
            if ((e.which && e.which == 13) || (e.keyCode && e.keyCode == 13)) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.tugas-tambahan.store-tugas-tambahan') }}",
                    dataType: "json",
                    data: {
                    ...
                    success: function (response) {
                        ...
                        $('.count-status-proses').text(response.total_tugas_tambahan_pending);
                    },
        ...
        function kirimIdMutasi(id) {
            $.ajax({
                url: "{{ route('admin.tugas-tambahan.list-tugas-tambahan', '') }}/" + id,
                type: "GET",
                data: {
                    id: id
                },
        ...
        // ketika form #add-tugas-tambahan di submit
        $('#add-tugas-tambahan').submit(function (e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    kirimIdMutasi(response.id_tugas_tambahan);
        ...
        function handleResponse(response, kd_karyawan) {
            switch (response.code) {
                ...
                case 3:
                    toastr.success(response.message, 'Success');
                    $('#kd_tugas_tambahan_form').val(response.id_tugas_tambahan);
