@extends('layouts.backend', ['title' => 'Edit Tugas Tambahan'])
    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        <div id="kt_app_content_container" class="app-container  container-fluid ">
            ...
            <form class="form" 
                ...
                id="update-tugas-tambahan"
                method="POST"
                action="{{ route('admin.tugas-tambahan.update-tugas-tambahan-on-process', ['id' => $tugasTambahanOnProcess->kd_tugas_tambahan]) }}"
            >
                @csrf
                @method('PATCH')
                <input type="hidden" name="kd_tugas_tambahan_form" id="kd_tugas_tambahan_form" value="">
                    ...
                    <div class="card-body p-lg-12">
                        <div class="row g-5 mb-5">
                            ...
                            <div class="col-12 ps-0">
                                <a href="{{ route('admin.tugas-tambahan.index') }}" class="btn btn-light fw-bold me-4">
                                    <i class="ki-duotone ki-arrow-left fs-2"><span class="path1"></span><span class="path2"></span></i>
                                    Kembali
                                </a>
                            </div>
                        </div>
                        <div class="row g-5 mb-5" id="list-tugas-tambahan">
                            <table class="table table-bordered table-stripped align-middle">
                                ...
                                <tbody>
                                    @php
                                        $gelar_depan = $tugasTambahanOnProcess->gelar_depan ? $tugasTambahanOnProcess->gelar_depan . ' ' : '';
                                        $gelar_belakang = $tugasTambahanOnProcess->gelar_belakang ? '' . $tugasTambahanOnProcess->gelar_belakang : '';
                                        $nama = $tugasTambahanOnProcess->nama;
                                        $nama_lengkap = $gelar_depan . $nama . $gelar_belakang;
                                    @endphp
                                    <tr>
                                        <td>{{ $tugasTambahanOnProcess->kd_karyawan }}</td>
                                        <td>{{ $nama_lengkap }}</td>
                                        <td>{{ $tugasTambahanOnProcess->jab_struk }}</td>
                                        <td>{{ $tugasTambahanOnProcess->ruangan }}</td>
                                        <td>{{ $tugasTambahanOnProcess->sub_detail }}</td>
                                        <td>
                                            <button
                                                type="button"
                                                class="btn btn-light btn-sm btn-active-light-danger me-2"
                                                data-id="{{ $tugasTambahanOnProcess->kd_tugas_tambahan }}"
                ...
                <div class="row g-5 mb-5" id="input-tugas-tambahan">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-body p-lg-12">
                                <div class="row g-5 mb-5">
                                    <div class="col-12 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid" name="isi_nota" id="isi_nota" rows="3">{!! $getDataTugasTambahanOnProcess->isi_nota ?? '' !!}</textarea>
                                        <div
                                ...
                                <div class="row g-5 mb-5">
                                    <div class="col-12 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid" name="isi_nota_2" id="isi_nota_2" rows="3">{!! $getDataTugasTambahanOnProcess->isi_nota_2 ?? 'Nota Tugas ini berlaku sejak tanggal ditetapkan.' !!}</textarea>
                                        <div
                                ...
                                <div class="row g-5 mb-5">
                                    <div class="col-md-8 fv-row">
                                        ...
                                        >
                                            ...
                                            @foreach ($jabatanStruktural as $item)
                                                <option
                                                    {{ $item->kd_jab_struk == $getDataTugasTambahanOnProcess->kd_jab_struk_baru ? 'selected' : '' }}
                                    ...
                                    <div class="col-md-4 fv-row">
                                        ...
                                        <input
                                            ...
                                            name="tmt_jabatan"
                                            id="tmt_jabatan" 
                                            value="{{ date('d-m-Y', strtotime($getDataTugasTambahanOnProcess->tmt_jabatan_baru)) }}"
                                        />
                                        <div
                                    ...
                                    <div class="col-12 fv-row">
                                        ...
                                        >
                                            ...
                                            @foreach ($subDetail as $item)
                                                <option
                                                    value="{{ $item->sub_detail }}"
                                                    {{ $item->sub_detail == $getDataTugasTambahanOnProcess->sub_detail_baru ? 'selected' : '' }}
                                                >
                                                    {{ $item->sub_detail }}
                                                </option>
                                            @endforeach
                            ...
                            <div class="card-body p-lg-12">
                                    ...
                                    <div class="col-12 fv-row">
                                        ...
                                        >
                                            ...
                                            @foreach ($divisi as $item)
                                                <option
                                                    {{ $item->kd_divisi == $getDataTugasTambahanOnProcess->kd_divisi_baru ? 'selected' : '' }}
                                                    value="{{ $item->kd_divisi }}"
                                                >
                                                    {{ $item->divisi }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="row g-5 mb-5">
                                    <div class="col-12 fv-row">
                                        ...
                                        >
                                            <option
                                                value="{{ $getDataTugasTambahanOnProcess->kd_divisi_baru }}"
                                            >
                                                {{ $getDataTugasTambahanOnProcess->unit_kerja_baru }}
                                            </option>
                                        </select>
                                        <div
                                ...
                                <div class="row g-5 mb-5">
                                    <div class="col-12 fv-row">
                                        ...
                                        >
                                            <option
                                                value="{{ $getDataTugasTambahanOnProcess->kd_sub_unit_kerja_baru }}"
                                            >
                                                {{ $getDataTugasTambahanOnProcess->sub_unit_kerja_baru }}
                                            </option>
                                        </select>
                                        <div
                                    ...
                                    <div class="col-12 fv-row">
                                        ...
                                        >
                                            ...
                                            @foreach ($ruangan as $item)
                                                <option
                                                    {{ $item->kd_ruangan == $getDataTugasTambahanOnProcess->kd_ruangan_baru ? 'selected' : '' }}
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#divisi').change(function() {
                ...
                let url = "{{ route('admin.tugas-tambahan.get-unit-kerja', ['id' => ':divisi']) }}";
                url = url.replace(':divisi', divisi);

                $.ajax({
                    url: "{{ route('admin.tugas-tambahan.get-unit-kerja', '') }}/" + divisi,
                    type: "GET",
                    dataType: "json",
                    data: {
                        id: divisi
            ...
            $('#unit').change(function() {
                ...
                let url = "{{ route('admin.tugas-tambahan.get-sub-unit-kerja', ['id' => ':unit', 'divisi' => ':divisi']) }}";
        ...
        $('#update-tugas-tambahan').submit(function (e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.code == 1) {
                        ...
                        // reset form #update-tugas-tambahan
                        $('#update-tugas-tambahan').trigger('reset');
    
                        // redirect
                        window.location.href = "{{ route('admin.tugas-tambahan-on-process.index') }}";
                    } else {
                        // toast error
        ...
        // $('#add-tugas-tambahan').submit(function (e) {
        //     e.preventDefault();
        ...
        //     // ambil kd_tugas_tambahan dan kd_karyawan kemudian masukkan kedalam #kd_tugas_tambahan dan #kd_karyawan
        //     var kd_tugas_tambahan = $('#kd_tugas_tambahan').val();
        //     var kd_karyawan = $('#kd_karyawan').val();
            
        //     var redirect = "{{ route('admin.tugas-tambahan-on-process.index') }}";
        //     $.ajax({
        //         url: url,
        //         type: method,
        //         data: data,
        ...
        //             kirimIdTugasTambahan(response.id_tugas_tambahan);
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.code == 2) {
                                ...
                                // reload page and redirect to tugas-tambahan.index
                                setTimeout(() => {
                                    window.location.href = "{{ route('admin.tugas-tambahan.index') }}";
                                }, 1000);
                            } else {
                                // toast error
                                toastr.error(response.message, 'Error');
