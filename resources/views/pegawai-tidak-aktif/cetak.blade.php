...
<body class='text-center' style="font-family: cambria" id="all" onLoad="cetak()">
    <table class="text-center t-font" style="margin-top: -20px; margin-bottom: -10px;" width="100%">
        <tr>
            <td width="140">
                <img src="{{ asset('assets/media/rsud-langsa/Langsa.png') }}" width="80" height="90" alt="Logo Langsa">
            </td>
    ...
    <b style='font-size:10pt;'>{{ $judul }}</b>
    
    <table class="table-print t-font" width="100%">
        <thead>
            <tr>
                <th rowspan=3 style="text-align:center; vertical-align: middle;">No.</th>
                <th rowspan=3 style="text-align:center; vertical-align: middle;">Nama <br>Tempat & Tgl.Lahir<br>NIP / No. KARPEG / ID Peg.</th>
        ...
        <tbody>
            ...
            @foreach($karyawan as $data)
                ...
                <tr>
                    ...
                    <td style='text-align:center; vertical-align: middle;'>{{ $data->masa_kerja_thn ?? 0 }}</td>
                    <td style='text-align:center; vertical-align: middle;'>{{ $data->masa_kerja_bulan ?? 0 }}</td>
                    ...
                    <td style='text-align:center;font-size:6pt;text-transform:uppercase;'>
                        Tenaga {{ $data->sub_detail }}<br>Pada {{ $data->ruangan }}
                    </td>
                </tr>
            @endforeach
        </tbody>
