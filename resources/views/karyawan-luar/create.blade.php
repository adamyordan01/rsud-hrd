@extends('layouts.backend', ['title' => 'Tambah Pegawai Luar'])
            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <span class="text-muted text-hover-primary">Tambah Pegawai Luar</span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="stepper stepper-pills" id="kt_stepper_example_basic">
                ...
                <form class="form" novalidate="novalidate" id="add-karyawan-luar" method="POST" action="{{ route('admin.karyawan-luar.store') }}">
                    @csrf
                    <div class="mb-5">
                        <!--begin::Step 1-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-5 mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input class="form-control form-control-solid" name="tmt" placeholder="Pick a date" id="tmt" />
                                    ...
                                    <div class="row g-5 mb-5">
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input class="form-control form-control-solid" name="tmt_akhir" placeholder="Pick a date" id="tmt_akhir" />
                                    ...
                                    <div class="row g-5 mb-5 sk-field d-none">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="no_sk" id="no_sk"/>
                                    ...
                                    <div class="row g-5 mb-5 keterangan-field d-none">
                                        <div class="col-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" rows="3" name="keterangan" id="keterangan"></textarea>
                                    ...
                                    <div class="row g-5 mb-5">
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="gelar_depan" id="gelar_depan" placeholder="Gelar depan"/>
                                        ...
                                        <div class="col-md-3 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="gelar_belakang" id="gelar_belakang" placeholder="Gelar belakang"/>
                                    ...
                                    <div class="row g-5 mb-5">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="ktp" id="ktp" placeholder="No. KTP"/>
                                    ...
                                    <div class="row g-5 mb-5">
                                        <div class="col-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" name="alamat" id="alamat" rows="3" 
                                                onkeyup="this.value=this.value.replace(/\b\w/g, l => l.toUpperCase())"></textarea>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-5 mb-5">
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="number" class="form-control form-control-solid" name="tinggi_badan" id="tinggi_badan" 
                                                placeholder="Tinggi (CM)" maxlength="3"/>
                                        ...
                                        <div class="col-md-4 fv-row">
                                            ...
                                            <input type="number" class="form-control form-control-solid" name="berat_badan" id="berat_badan" 
                                                placeholder="Berat (KG)" maxlength="3"/>
                                    ...
                                    <div class="row g-5 mb-5">
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="npwp" id="npwp" placeholder="NPWP"/>
                                    ...
                                    <div class="row g-5 mb-5">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="no_kk" id="no_kk" placeholder="No. KK"/>
                                    ...
                                    <div class="row g-5 mb-5">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="no_hp" id="no_hp" placeholder="No. HP"/>
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="hp_alternatif" id="hp_alternatif" placeholder="No. Alternatif"/>
                                    ...
                                    <div class="row g-5 mb-5">
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="bsi" id="bsi" 
                                                placeholder="No. Rekening BSI" maxlength="10"/>
...
@push('scripts')
    <script>
        ...
        // Form submission
        $('#add-karyawan-luar').on('submit', function(e) {
            e.preventDefault();
