<div class="d-block gap-2 flex-wrap justify-content-end">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
        ...
        <div class="menu-item px-3">
            <a href="{{ route('admin.karyawan-luar.show', $karyawan->kd_peg_luar) }}" class="menu-link px-3">
        ...
        <div class="menu-item px-3">
            <a href="{{ route('admin.karyawan-luar.edit', $karyawan->kd_peg_luar) }}" class="menu-link px-3">
